...
| `docs/change-tracker` | Stop | Nags about uncommitted work, keeping the issue true, promoting findings out of `.workkit/`, and unfiled inbox notes — once per change (#132), staying silent on every stop that follows while nothing has moved |
