...
| `triage` | Routes every captured entry to exactly one home and prints the Filed trail; its `merge` mode sweeps the open board and proposes merges, executing only on approval |
