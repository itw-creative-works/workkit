...
const PAYLOAD = {
  ...
  counts: { open: 12, waiting: 2, ready: 3, inFlight: 1, inbox: 5, parked: 1 },
  closedDay: 4,
  repoCounts: [
...
const EXPECTED = '<!-- workkit-stats: {"v":1,"date":"2026-08-03","totals":{"open":12,"waiting":2,"ready":3,"inFlight":1,"inbox":5,"parked":1},"closedDay":4,"repos":{"ITW-Creative-Works/workkit":{"open":9},"ianwieds/.dotfiles":{"open":3}}} -->';
...
const run = async () => {
  ...
  await test('the numbers absent from a payload are zeros, not gaps', () => {
    ...
    assertEq(out, '<!-- workkit-stats: {"v":1,"date":"2026-08-03","totals":{"open":1,"waiting":0,"ready":0,"inFlight":0,"inbox":0,"parked":0},"closedDay":0,"repos":{}} -->',
