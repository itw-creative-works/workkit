...
//
// It exists for the two dialogs that ride EVERY page. The intake dialog is on
// the topbar (issue #20: "stays reachable from the topbar on every page, not
// buried on a tab") and the issue dialog opens from four of the six pages — and
// the main bundle is the only entry every page loads, so a page module would
// wire them on one page and leave them dead on the rest.
//

import coreMain from '__main_assets__/js/main.js';
import omega from '@omega.js/client';
import { mountIntake } from './libs/tower/intake.js';
import { mountIssueModal } from './libs/tower/modal.js';
