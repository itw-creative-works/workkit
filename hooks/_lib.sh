...
# (the git-commit detection trio below); safety/proof-guard + safety/tree-guard +
...
# (hook_sha1 and the two marker paths below, plus scripts/review-marker.sh and
...
# fallback chain is the portable form: hook_file_mtime below (BSD `stat -f`
